            ...
            <div id="left_side_content_type" style="{{ $model->content_type == 'Left Side Picture' ? '' : 'display: none;' }}">
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea name="left_side_content" id="left_side_content" cols="30" rows="4">{{ $model->content }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div id="right_side_content_type" style="{{ $model->content_type == 'Right Side Picture' ? '' : 'display: none;' }}">
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea name="right_side_content" id="right_side_content" cols="30" rows="4">{{ $model->content }}</textarea>
                    </div>
                </div>
            </div>
