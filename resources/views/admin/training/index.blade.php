...
<!--    $js = ['bank'];-->
<!--@endphp-->
<!--@extends('layouts.app', ['title' => _lang('Training'), 'modal' => ''])-->
<!--@section('page.header')-->
...
<!--				<span class="breadcrumb-item active">{{ _lang('Training') }}</span>-->
<!--			</div>-->
...
<!--		<h5 class="card-title">{{ _lang('Training') }}-->
		    
<!--		</h5>-->
<!--		<div class="header-elements">-->
<!--            <a href="{{ route($route.'create') }}">-->
<!--			    <button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round"><i class="icon-stack-plus mr-1"></i> {{ _lang('Create Training') }}</button>-->
<!--            </a>-->
<!--		</div>-->
<!--	</div>-->
<!--	<div class="card-body">-->
