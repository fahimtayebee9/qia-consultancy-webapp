@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Create About Us Content')])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="{{ route( $route . 'index') }}"  class="breadcrumb-item active">{{ _lang('About Us') }}</a>
				<span class="breadcrumb-item active">{{ _lang('Create About Us Content') }}</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('Create New About Us Content') }}
		    
		</h5>
		<div class="header-elements">
            <a href="{{ route($route.'index') }}">
			    <button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round"><i class="icon-stack-plus mr-1"></i> {{ _lang('Back to About Us') }}</button>
            </a>
		</div>
	</div>
	<div class="card-body">
