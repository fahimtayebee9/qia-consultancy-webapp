@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Update About Us Content')])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="{{ route( $route . 'index') }}"  class="breadcrumb-item active">{{ _lang('About Us Content') }}</a>
				<span class="breadcrumb-item active">{{ _lang('Update About Us Content') }}</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('Update About Us Content Information') }}
		    
		</h5>
		<div class="header-elements">
            <a href="{{ route($route.'index') }}">
			    <button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round"><i class="icon-stack-plus mr-1"></i> {{ _lang('Back to About Us Content') }}</button>
            </a>
		</div>
	</div>
	<div class="card-body">
		...
		<form class="form-validate-jquery" id="content_form"  action="{{ route($route . 'update', $model->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea name="description" id="description" cols="30" rows="4" class="form-control">{{ $model->description }}</textarea>
                </div>
