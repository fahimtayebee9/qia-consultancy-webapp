@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Create Blog')])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="{{ route( $route . 'index') }}"  class="breadcrumb-item active">{{ _lang('Blog') }}</a>
				<span class="breadcrumb-item active">{{ _lang('Create Blog') }}</span>
			</div>
	...
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		...
		<div class="header-elements">
            <a href="{{ route($route.'index') }}">
			    <button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round"><i class="icon-stack-plus mr-1"></i> {{ _lang('Back to Blog') }}</button>
            </a>
		</div>
	</div>
	<div class="card-body">
		<form class="form-validate-jquery" id="content_form"  action="{{ route($route . 'store') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <input type="file" name="blog_bg" id="blog_bg" class="form-control dropify" required>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="file" name="main_photo" id="main_photo" class="form-control dropify" required>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="file" name="cover_photo" id="cover_photo" class="form-control dropify" required>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="main_photo_alt_tag" id="main_photo_alt_tag" class="form-control" placeholder="Enter Photo Alter Tag" required>
                </div>

                <div class="col-md-6 form-group">
                    <label for="cover_photo_alter_tag">Cover Photo Alter Tag <span class="text-danger">*</span></label>
                    <input type="text" name="cover_photo_alter_tag" id="cover_photo_alter_tag" class="form-control" placeholder="Enter Photo Alter Tag" required>
                </div>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <select name="author_id" id="author_id" class="form-control select" data-placeholder="Select Author" required data-parsley-errors-container="#sub_category_id_error">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <input type="text" name="site_title" id="site_title" class="form-control" placeholder="Enter Page Title" required>
                </div>
                ...
                <div class="col-md-12 form-group">
                    ...
                    <select name="tags[]" id="tags" multiple class="form-control select" data-placeholder="Select Tag">
