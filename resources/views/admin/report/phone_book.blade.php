@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Phone Book Report'), 'modal' => 'lg'])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breanewsletterdcrumb-item active">{{ _lang('Phone Book Report') }}</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('Phone Book Report') }}
	...
	<div class="card-body">
		<div class="row">
            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-bordered content_managment_table" data-url="{{ route($route.'phone_book.datatable') }}">
                    <thead>
                        <tr>
                            <th>{{ _lang('id') }}</th>
                            <th>{{ _lang('Date') }}</th>
