@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Static Page Report'), 'modal' => 'lg'])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breanewsletterdcrumb-item active">{{ _lang('Static Page Report') }}</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('Static Page Report') }}
	...
	<div class="card-body">
		<div class="row">
            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-bordered content_managment_table" data-url="{{ route($route.'static_page_data.datatable') }}">
                    <thead>
                        <tr>
                            <th>{{ _lang('id') }}</th>
                            <th width="10%">{{ _lang('Date') }}</th>
                            <th width="10%">{{ _lang('Name') }}</th>
                            <th width="25%">{{ _lang('Email') }}</th>
                            <th width="10%">{{ _lang('Designation') }}</th>
                            <th width="10%">{{ _lang('Company') }}</th>
                            <th width="20%">{{ _lang('Origin') }}</th>
                            <th width="20%">>{{ _lang('Message') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
