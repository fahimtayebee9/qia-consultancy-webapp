        ...
        <div class="row">
            <div class="col-lg-7 col-md-12 pr-140 md-mb-70 md-pr-15">
                <div class="content-wrap">
                    <h1 class="it-title">Corrective and Preventive Action</h1>
                    <div class="description">
                        <p class="desc">
                            An effective quality management system is the difference between a good business and a great one. Our QISS QMS solutions are designed to provide sustainable outcomes focused on continuous improvement.
                        </p>
            ...
            <div class="col-md-6" style= "margin-left: 725px; margin-top: -412px;" >
                <div class="services-img"style= "margin-right: 110px;" >
                    <a href="https://www.youtube.com/watch?v=AShlRhEEDEw" target="_blank">
            ...
            <div class="col-lg-6 md-pb-60">
                <div class="sec-title mb-40">
                    ...
                    <h3 class="title pb-20">
                        Access Pre-configured Documentation for Faster and Smoother ISO Compliance
                    </h3>
                    <div class="desc">
                        Enhance the way you manage corrective and preventative actions and discover how we give our customers the tools to improve business functioning and make better informed actions. Our CAPA processes help you to improve and ensure you’re getting the maximum value from the framework.
                    </div>
                </div>
                <div class="services-wrap mb-25">
                    ...
                    <div class="services-text">
                        <h3 class="title"><a href="">Guided Workflows</a></h3>
                        <p class="services-txt">QISS is a sustainable QMS software that can reduce the non-conformance and discrepancies caused by the impact of traditional event planning. QISS web-based QMS workflow system ensurs that all necessary steps are taken and documented in a consistent manner.</p>
                    </div>
                </div>
                <div class="services-wrap mb-25">
                    <div class="services-icon">
                    ...
                    <div class="services-text">
                        ...
                        <p class="services-txt">QISS has a predefined report, and you can also customize the analytic report and advance searching with our high-powered QISS quality management software.</p>
                    </div>
                </div>
                <div class="services-wrap">
                    ...
                    <div class="services-text">
                        <h3 class="title"><a href="">Resolution Planning</a></h3>
                        <p class="services-txt">Reduce mislabeling and recalls, drive logistical efficiencies, and improve quality to reduce the amount of acceptable waste in your organization.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="image-part">
                    <img src="{{ asset('static/assets/images/choose/landing-corrective-and-preventive-action.jpg') }}" alt="">
                </div>
                <div class="animation">
                    <div class="top-shape">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="sec-title mb-50">
                    ...
                    <div class="desc">
                        Get our interactive demo to see how our all-in-one QISS QMS makes your work easier with integrated document, sustainable data, problem evaluation, implementation and quality management. 
                    </div>
                </div>
                                    ...
                                    <div class="counter-list">
                                        <div class="counter-text">
                                            <div class="count-number">
                                                <span class="qia-count plus orange-color">450</span>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-10 pt-40 sm-pt-0 sm-pr-0 sm-pl-0">
                                <div class="services-item mb-20">
                                    ...
                                    <div class="services-content">
                                        <div class="services-text">
                                            <h3 class="title"><a href="">Reduce Costs and Waste</a></h3>
                                        </div>
                                        <div class="services-desc">
                                            <p>
                                                Reducing costs and waste through quick and effective issue resolution.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="services-item cyan-bg">
                                    ...
                                    <div class="services-content">
                                        <div class="services-text">
                                            <h3 class="title"><a href="">Proactively Driving</a></h3>
                                        </div>
                                        <div class="services-desc">
                                            <p>
                                                Compliance becomes natural and intuitive.
                                            </p>
                                        </div>
                                    </div>
                                </div>  
                            ...
                            <div class="col-md-6 pl-10 sm-pr-0 sm-pl-0 sm-mt-20">
                                <div class="services-item gold-bg mb-20">
                                    ...
                                    <div class="services-content">
                                        <div class="services-text">
                                            <h3 class="title"><a href="">Tracking and Managing</a></h3>
                                        </div>
                                        <div class="services-desc">
                                            <p>
                                                Processes are automated and standardized with configurable email notification.<br>
                                                <br>
                                                <br>
                                            </p>
                                        </div>
                                ...
                                <div class="services-item blue-bg">
                                    ...
                                    <div class="services-content">
                                        <div class="services-text">
                                            <h3 class="title"><a href="">Incident Root Cause Analysis</a></h3>
                                        </div>
                                        <div class="services-desc">
                                            <p>
                                                Pinpoint the issuse to set the Goal
                                            </p>
                                        </div>
                                    </div>
                                </div>  
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-7 md-mb-30">
                <div class="sec-title mb-40">
                    ...
                    <div class="desc">
                        Get a consultation service to assist you with complex and technical questions<br>
                        related to customer connection applications.
                    </div>
                </div>
                <div class="services-wrap mb-25">
                    <div class="services-icon">
                ...
                <div class="services-wrap">
                    ...
                    <div class="services-text">
                        ...
                        <p class="services-txt">17625 El Camino Real, Suite 395, Houston, TX 77058 USA</p>
                    </div>
                </div>
            </div>
