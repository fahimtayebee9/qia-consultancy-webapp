        ...
        <div class="row">
            <div class="col-lg-7 col-md-12 pr-140 md-mb-70 md-pr-15">
                <div class="content-wrap">
                    ...
                    <p class="get-demo-form" id="get_demo_form_area">
                        <input type="text" id="get_demo_email" placeholder="{{ get_option('banner_input_placeholder') }}"> 
                        <button type="button" id="get_demo_request_one">
                            {{ get_option('banner_button_text') }}
                        </button>
                    </p>
                    <p id="get_demo_content_box" style="display: none;" class="get-demo-form-textare">
                        <textarea placeholder="Enter your details here" name="get_demo_content" id="get_demo_content" class="form-control" cols="30" rows="3"></textarea>
                    ...
                    <figure>
                        <picture style="display: flex;">
                            <a href="https://www.capterra.com/reviews/104370/QISS-Quality-Management-System?utm_source=vendor&amp;utm_medium=badge&amp;utm_campaign=capterra_reviews_badge" target="_blank"> <img border="0" src="https://www.qi-a.com/storage/upload/cap-badge-same.png?v=2069264&amp;p=104370" alt="qiss capterra"> </a>
                            <a href="https://www.getapp.com/operations-management-software/a/qiss-quality-management-system/reviews/" target="_blank"> <img border="0" src="https://www.qi-a.com/storage/upload/get-app-same.png" alt="qiss get app"> </a>
                            <a href="https://www.softwareadvice.com/compliance/qiss-quality-management-system-profile/reviews/" target="_blank"> <img border="0" src="https://www.qi-a.com/storage/upload/soft-badge-same.png" alt="qiss software advice"> </a>
                        </picture>
                    </figure>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 pl-32 md-pl-15">
                <h4 class="mb-3">Click for Module Videos - {{ Route::currentRouteName() }}</h4>
                    ...
                    @foreach ($trainings as $trainingItem)
                        <div class="col-md-12">
                            <div class="card flex-row">
                                ...
                                <!--</div>-->
                                <img style="width:200px;height: fit-content;" class="card-img-left example-card-img-responsive" src="{{ asset('storage/training/'. $trainingItem->picture) }}" alt="training"/>
                                <div class="card-body">
                        ...
                        @foreach ($caseStudies as $caseStudy)
                            <div class="project-item">
                                <div class="project-img">
                                    <a href="{{ $caseStudy->link }}" {{ $caseStudy->open_another_tab == 1 ? 'target="_blank"' : '' }}">
                                        <img src="{{ asset('storage/home-page-content/'. $caseStudy->picture) }}" alt="{{ $caseStudy->alt_tag }}">
                                    </a>
                                </div>
