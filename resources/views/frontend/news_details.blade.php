...
<div class="qia-breadcrumbs img4" style="background-image: url({{ asset('storage/news/'. $blog->blog_bg) }})" >
    <div class="breadcrumbs-inner text-center" style="padding: 50px 0px;">
        ...
        <ul>
            ...
            <li title="Go to Blog"><a class="active" href="{{ URL::to('news') }}">News Flash</a></li>
            <li>{{ $blog->header }}</li>
        </ul>
    </div>
</div>
                    ...
                    <div class="recent-posts mb-50">
                        ...
                        @foreach ($relatedPosts as $post)
                            <div class="recent-post-widget">
                                <div class="post-img">
                                    <a href="{{ $post->slug }}"><img src="{{ asset('storage/news/'. $post->cover_photo) }}" alt="{{ $post->cover_photo_alter_tag }}"></a>
                                </div>
                                <div class="post-desc">
                    ...
                    <div class="col-lg-12">
                        <div class="blog-details">
                            <div class="bs-img mb-35">
                                <img src="{{ asset('storage/news/'. $blog->main_photo) }}" alt="{{ $blog->main_photo_alter_tag }}">
                            </div>
                            <div class="blog-full">
