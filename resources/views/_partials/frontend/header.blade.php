            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 qi-a-logo-area">
                        <div class="logo-part">
							@if(Request::url() === 'https://www.qi-a.com/qiss-lab')
								<a href="https://www.qi-a.com/qiss-lab">
									<img src="https://www.qi-a.com/storage/upload/qisslab_logo-new-remove.webp" alt="ICS Legal Logo">
								</a>
							@else 
								<a href="{{ URL::to('/') }}">
									<img src="{{ asset('storage/logo/'. get_option('logo')) }}" alt="{{ get_option('logo_alter_tag') }}">
								</a>
							@endif
                    ...
                    <div class="col-lg-9 qi-a-main-menu-area">
                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        @foreach ($serviceCategories as $category)
                                            <li class="qia-mega-menu menu-item-has-children current-menu-item">
												@if($category->name == 'QISS LAB')
													<a href="{{route('qiss-lab')}}">{{ $category->name }}</a>
												@elseif($category->name == 'QISS QMS')
													<a href="https://www.qi-a.com">{{ $category->name }}</a>
												@else
                                        ...
                                        <li>
                                            <a href="{{route('learning-center')}}" style="margin-right: 25px;">Learning Center</a>
                                        </li>
                                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-15506">
