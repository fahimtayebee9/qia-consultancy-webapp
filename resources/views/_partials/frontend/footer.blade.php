        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 pl-45 md-pl-15 md-mb-30">
                    <h4 class="footer-header widget-title">Our Modules</h4>
                    <ul class="site-map">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 md-mb-30">
                    <h5 class="footer-header widget-title">Contact Info</h5>
            ...
            <div class="row y-middle">
                <div class="col-lg-6 text-right md-mb-10 order-last">
                    <ul class="copy-right-menu">
                        ...
                        <li><a href="{{ URL::to('qia-privacy-policy') }}">Privacy Policy</a></li>
