...
<div class="card card-sidebar-mobile  noprint">
	<ul class="nav nav-sidebar" data-nav-type="accordion">
		...
		<li class="nav-item">
			<a href="{{ route('admin.report.phone_book') }}" class="nav-link{{ Request::is('admin/report/phone-book') ? ' active' : '' }}">
				<i class="icon-magazine"></i>
				<span>
					{{_lang('Phone Book Request')}}
				</span>
			</a>
		</li>
		
		<li class="nav-item">
			<a href="{{ route('admin.report.static_page_data') }}" class="nav-link{{ Request::is('admin/report/static_page_data') ? ' active' : '' }}">
				<i class="icon-magazine"></i>
				<span>
					{{_lang('Static Page Form')}}
				</span>
			</a>
		</li>
		...
		<li class="nav-item">
			<a href="{{ route('admin.text-messaging') }}" class="nav-link{{ Request::is('admin/text-messaging') ? ' active' : '' }}">
				<i class="icon-magazine"></i>
				<span>
					{{_lang('Test Messageing')}}
				</span>
			</a>
		</li>
