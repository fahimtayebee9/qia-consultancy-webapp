...
class BlogAuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['success' => true, 'status' => 'success', 'message' => _lang('Author Created'), 'goto' => route('admin.blog-author.index')]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['success' => true, 'status' => 'success', 'message' => _lang('Author Updated'), 'goto' => route('admin.blog-author.index')]);
