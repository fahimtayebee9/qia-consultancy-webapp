...
Route::get('capa-management', 'FrontendController@staticCapaManagement')->name('capa-management');
Route::get('qms-management', 'FrontendController@staticQMSManagement')->name('qms-management');
...
Route::post('submit-text-messaging-form','FrontendController@submit_text_messaging_form')->name('submit-text-messaging-form');
...
Route::get('text-messaging-opt-in', 'FrontendController@text_messaging')->name('text-messaging-opt-in');
...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'namespace' => 'admin', 'middleware' => ['auth']], function () {
	...
	Route::get('report/static_page_data/datatable', 'ReportController@static_page_datatable')->name('report.static_page_data.datatable');
	Route::get('report/static_page_data', 'ReportController@static_page_data')->name('report.static_page_data');
	...
	Route::get('report/phone-book/datatable', 'ReportController@phone_book_datatable')->name('report.phone_book.datatable');
	Route::get('report/phone-book', 'ReportController@phone_book')->name('report.phone_book');
	Route::get('report/phone-book/delete/{id}', 'ReportController@delete_phone_book')->name('report.phone_book.delete');
	...
	Route::get('text-messaging', 'OtherController@text_messaging')->name('text-messaging');
